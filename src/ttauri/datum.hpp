...
public:
    ...
    datum_impl(unsigned long long value) noexcept : u64(integer_mask | value)
    {
        if (value > maximum_int) {
            ...
            {
                throw std::overflow_error("Constructing datum from integer {}, larger than {}", value, maximum_int);
            }
        }
    }
    ...
    datum_impl &operator=(signed long long rhs) noexcept
    {
        ...
        if (rhs < minimum_int || rhs > maximum_int) {
            ...
            {
                throw std::overflow_error("Assigning integer {} to datum, outside {} and {}", rhs, minimum_int, maximum_int);
            }
        }
